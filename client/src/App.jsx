...
import DoctorPrescriptionsPage from './pages/dashboards/DoctorPrescriptionsPage';
import DoctorNotesPage from './pages/dashboards/DoctorNotesPage';
import DoctorRatingsPage from './pages/dashboards/DoctorRatingsPage';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={['family']} />}>
            <Route
              path="/family"
              element={<Navigate to="/family/care-plan" replace />}
            />
          ...
          <Route element={<ProtectedRoute allowedRoles={['doctor']} />}>
            <Route
              path="/doctor"
              element={<Navigate to="/doctor/sessions" replace />}
            />
